...
class Controller with ChangeNotifier{
  ...
  Controller(){
    ...
    state = AppState(); 
    stateFuture = Future(()=>restoreState());
  }
  ...
  Future<AppState> restoreState() async {
    ...
    CroakController croakCtrlr = CroakController();
    TagController tagCtrlr = TagController();
    croakCtrlr.croakStore = state.localCroaks;
    tagCtrlr.tagStore = state.query.localTags;
